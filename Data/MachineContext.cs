...
namespace ComputerInventory.Data
{
    class MachineContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(@"Server=LAPTOP-81;Database=BegEFCore2;Trusted_Connection=false;User ID=khyky_user;Password=12345!a");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MachineWarranty>(entity =>
            {
                ...
                entity.Property(e => e.WarrantyProviderId).HasColumnType("WarrantyProviderID");
